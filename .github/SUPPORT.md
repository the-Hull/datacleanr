# Getting help with datacleanr

Thanks for using datacleanr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/datacleanr/issues) to make sure the 
