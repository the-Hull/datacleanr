...
module_server_plot_selectable <- function(input, output, session, df, group_row, selector_inputs, sel_points){
  ...
  shiny::observeEvent(plotly::event_data("plotly_click", source = "scatterselect", priority = "event"),

                      {
                        ...
                        #         "addTraces",
                        #         list(
                        #           x = add_points[ , as.character(selector_inputs$xvar), drop = TRUE],
                        #           y = add_points[ , as.character(selector_inputs$yvar), drop = TRUE],
                        #           type = "scatter",
                        #           mode = "markers",
                        #           name = "outlier",
                        ...
                        #
                        #     # update the old keys
                        #     shiny::isolate(old_keys(sel_points$df$keys))
                        #
                        #   } else {
                        #
                        #     cat("WE DOWN\n")
  ...
  shiny::observeEvent(plotly::event_data("plotly_selected", source = "scatterselect", priority = "event"),

                      {
                        ...
                        #
                        #
                        #     print("this is from add traces selected")
                        #     plotly::plotlyProxy("scatterselect", session) %>%
                        #       plotly::plotlyProxyInvoke(
                        #         "addTraces",
                        #         #
