...
`datacleanr` is a general-purpose and efficient tool for data cleaning (filtering and outlier selection / annotation).
It is inherintely interoperable, by seamlessly integrating into **reproducible** data analyses pipelines.
